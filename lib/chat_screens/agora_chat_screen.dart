...
class AgoraChatScreen extends StatefulWidget {
  ...
  const AgoraChatScreen({Key? key, required this.userName}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            const SizedBox(height: 10),
             Text("login userId: ${AgoraChatConfig.agoraUserId}"),
             Text("agoraToken: ${AgoraChatConfig.agoraUserToken}"),
            const SizedBox(height: 10),
            Row(
  ...
  void _signIn() async {
    try {
      await ChatClient.getInstance.loginWithAgoraToken(
        AgoraChatConfig.agoraUserId,
        AgoraChatConfig.agoraUserToken,
      );
      _addLogToConsole("login succeed, userId: ${AgoraChatConfig.agoraUserId}");
